...
| 2D peak map | Native aggregation, colormaps, zoom/pan/measure, history, axis swap, exact ranges, minimap | **Complete:** native OpenMS density-aware raster (RT pixels capped by visible MS1 scan positions), viridis/plasma/magma/grayscale maps, wheel/box zoom, pan, measurement, history, axis swap, exact ranges, cached clickable full-run minimap and viewport indicator |
